...
import 'dart:convert';
import 'package:adventure_bag/models/item.dart';
import 'package:adventure_bag/screens/detail_item.dart';
...
class _ProductPageState extends State<ProductPage> {
  Future<List<Product>> fetchProduct() async {
    ...
    var url = Uri.parse('https://pesolcsgoskinstore.vercel.app/json/');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Your Orders Here'),
      ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                       ...
                       const SizedBox(height: 10),
                        Text("${snapshot.data![index].fields.payment}"),
                      ],
                    ),
                  ),
                ),
